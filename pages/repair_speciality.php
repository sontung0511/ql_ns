...
if(isset($_SESSION['username']) && isset($_SESSION['level']))
{
  ...
  if(isset($_POST['save']))
  {
    ...
    if(empty($titleSpecial))
      $error['titleSpecial'] = 'Please enter <b> Name specialize </b>';
    ...
    if(!$error)
    {
      ...
      echo '<script>setTimeout("window.location=\'sua-speciality.php?p=staff&a=specialize&id='.$id.'\'",1000);</script>';
    }
...
specialize
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="speciality.php?p=staff&a=specialize">
specialize</a></li>
        <li class="active">Correction 
repair 
specialize</li>
      </ol>
    </section>
                ...
                <div class="row">
                  <div class="col-md-12">
                    <div class="form-group">
                      <label for="exampleInputEmail1">Code 
specialize: </label>
...
Import Name 
specialize" name="titleSpecial" value="<?php echo $row['ten_chuyen_mon']; ?>">
                    </div>
                    <div class="form-group">
