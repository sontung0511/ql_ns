...
if(isset($_SESSION['username']) && isset($_SESSION['level']))
{
  ...
  if(isset($_POST['edit']))
  {
    ...
    echo "<script>location.href='sua-degree.php?p=staff&a=certificate&id=".$id."'</script>";
  }
  ...
  if(isset($_POST['save']))
  {
    ...
    if(empty($certificateName))
      $error['certificateName'] = 'Please enter <b> Name qualifications </b>';
    ...
    if(!$error)
    {
      ...
      if($result)
      {
        $success['success'] = 'More qualifications 
success';
        echo '<script>setTimeout("window.location=\'degree.php?p=staff&a=certificate\'",1000);</script>';
      }
    }
  }
  ...
  if(isset($_POST['delete']))
  {
    ...
    $success['success'] = 'Successfully deleted degree.';
    echo '<script>setTimeout("window.location=\'degree.php?p=staff&a=certificate\'",1000);</script>';
  }
      ...
      <div class="modal-content">
        <form method="POST">
          ...
          <div class="modal-body">
            ...
            Do you really want to delete this degree?
          </div>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="degree.php?p=staff&a=certificate">qualifications</a></li>
        <li class="active">More qualifications</li>
      </ol>
    </section>
        ...
        <div class="col-xs-12">
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">More qualifications</h3>
            ...
            <div class="box-body">
              <?php 
                ...
                if($row_acc['quyen'] != 1) 
                {
                  ...
                  echo "you<b> no permission </b> to perform this function.";
                  echo "</div>";
                }
              ?>
                ...
                <div class="row">
                  <div class="col-md-12">
                    <div class="form-group">
                      <label for="exampleInputEmail1">Code qualifications: </label>
                      <input type="text" class="form-control" id="exampleInputEmail1" name="speacialCode" value="<?php echo $certificateCode; ?>" readonly>
                    </div>
                    <div class="form-group">
                      <label for="exampleInputEmail1">Name qualifications: </label>
                      <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Import Name qualifications" name="certificateName">
                    </div>
                    <div class="form-group">
                    ...
                    <?php 
                      if($_SESSION['level'] == 1)
                        echo "<button type='submit' class='btn btn-primary' name='save'><i class='fa fa-plus'></i> More qualifications</button>";
                    ?>
                  </div>
                  <!-- /.col -->
                </div>
          ...
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">List qualifications</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
