...
if(isset($_SESSION['username']) && isset($_SESSION['level']))
{
  ...
  {
    $id = $_POST['idRoom'];
    echo "<script>location.href='sua-department.php?p=staff&a=room&id=".$id."'</script>";
  }
  ...
  if(isset($_POST['save']))
  {
    ...
    if(!$error)
    {
      ...
      $success['success'] = 'Create Department success.';
      echo '<script>setTimeout("window.location=\'department.php?p=staff&a=room\'",1000);</script>';
    }
  ...
  if(isset($_POST['delete']))
  {
    ...
    $success['success'] = 'Delete Department success.';
    echo '<script>setTimeout("window.location=\'department.php?p=staff&a=room\'",1000);</script>';
  }
      ...
      <div class="modal-content">
        <form method="POST">
          ...
          <div class="modal-body">
            ...
            You do you really want Delete Department here?
          </div>
                ...
                <div class="row">
                  <div class="col-md-12">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Import Name Department" name="roomName">
                    </div>
                    <div class="form-group">
                    ...
                    <?php 
                      if($_SESSION['level'] == 1)
                        echo "<button type='submit' class='btn btn-primary' name='save'><i class='fa fa-plus'></i> Create Department</button>";
                    ?>
                  </div>
                  <!-- /.col -->
                </div>
