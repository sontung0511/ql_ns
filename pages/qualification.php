...
if(isset($_SESSION['username']) && isset($_SESSION['level']))
{
  ...
  {
    $id = $_POST['idLevel'];
    echo "<script>location.href='sua-qualification.php?p=staff&a=level&id=".$id."'</script>";
  }
  ...
  if(isset($_POST['save']))
  {
    ...
    // validate
    if(empty($titleLevel))
      $error['titleLevel'] = 'Please enter <b> Name level </b>';
    ...
    if(!$error)
    {
      ...
      $success['success'] = 'Add level success';
      echo '<script>setTimeout("window.location=\'qualification.php?p=staff&a=level\'",1000);</script>';
    }
      ...
      <div class="modal-content">
        <form method="POST">
          ...
          <div class="modal-body">
            ...
            You do you really want Delete level here?
          </div>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="qualification.php?p=staff&a=level">level</a></li>
                ...
                <div class="row">
                  <div class="col-md-12">
                    <div class="form-group">
                      <label for="exampleInputEmail1">Code level: </label>
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Import Name level" name="titleLevel">
                    </div>
                    <div class="form-group">
                    ...
                    <?php 
                      if($_SESSION['level'] == 1)
                        echo "<button type='submit' class='btn btn-primary' name='save'><i class='fa fa-plus'></i> Add level</button>";
                    ?>
                  </div>
                  <!-- /.col -->
                </div>
