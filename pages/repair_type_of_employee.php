  ...
  if(isset($_POST['save']))
  {
    ...
    if(!$error)
    {
      ...
      if($result)
      {
        ...
        echo '<script>setTimeout("window.location=\'sua-type -of-employee.php?p=staff&a=employee-type&id='.$id.'\'",1000);</script>';
      }
    }
  }
      ...
      <div class="modal-content">
        <form method="POST">
          ...
          <div class="modal-body">
            ...
            You do you really wan Delete type employee 
here?
          </div>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="type -of-employee.php?p=staff&a=employee-type">type employee</a></li>
        <li class="active">Create type employee</li>
      </ol>
    </section>
...
Import Name type" name="typeName" value="<?php echo $row['ten_loai_nv']; ?>">
                    </div>
                    <div class="form-group">
