...
if(isset($_SESSION['username']) && isset($_SESSION['level']))
{
  ...
  if(isset($_POST['edit']))
  {
    ...
    echo "<script>location.href='sua-mission.php?p=collaborate&a=list-collaborate&id=".$idCongTac."'</script>";
  }
  ...
  if(isset($_POST['delete']))
  {
    ...
    {
      $showMess = true;
      $success['success'] = 'Delete mission. success.';
      echo '<script>setTimeout("window.location=\'mission_list.php?p=collaborate&a=list-collaborate\'",1000);</script>';
    }
  }
      ...
      <div class="modal-content">
        <form method="POST">
          ...
          <div class="modal-body">
            ...
            You do you really wan Delete mission here?
          </div>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="mission_list.php?p=collaborate&a=list-collaborate">mission.</a></li>
        <li class="active">List mission.</li>
      </ol>
    </section>
        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">List mission.</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
