...
success';
      echo '<script>setTimeout("window.location=\'sua-qualification.php?p=staff&a=level&id='.$id.'\'",1000);</script>';
    }
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Correction repair level</li>
      </ol>
    </section>
        ...
        <div class="col-xs-12">
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Correction repair level</h3>
                ...
                <div class="row">
                  <div class="col-md-12">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Import Name level" name="titleLevel" value="<?php echo $row['ten_trinh_do']; ?>">
                    </div>
                    <div class="form-group">
