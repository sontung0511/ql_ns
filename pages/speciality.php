...
if(isset($_SESSION['username']) && isset($_SESSION['level']))
{
  ...
  {
    $id = $_POST['idSpecial'];
    echo "<script>location.href='sua-speciality.php?p=staff&a=specialize&id=".$id."'</script>";
  }
  ...
  if(isset($_POST['save']))
  {
    ...
    if(empty($titleSpecial))
      $error['titleSpecial'] = 'Please enter <b> Name 
specialize </b>';
    ...
    if(!$error)
    {
      ...
      $success['success'] = 'Add specialize success';
      echo '<script>setTimeout("window.location=\'speciality.php?p=staff&a=specialize\'",1000);</script>';
    }
  ...
  if(isset($_POST['delete']))
  {
    ...
    $success['success'] = 'Delete specialize success.';
    echo '<script>setTimeout("window.location=\'speciality.php?p=staff&a=specialize\'",1000);</script>';
  }
      ...
      <div class="modal-content">
        <form method="POST">
          ...
          <div class="modal-body">
            ...
            You do you really want Delete specialize here?
          </div>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="speciality.php?p=staff&a=specialize">specialize</a></li>
        <li class="active">Add specialize</li>
      </ol>
    </section>
        ...
        <div class="col-xs-12">
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Add specialize</h3>
                ...
                <div class="row">
                  <div class="col-md-12">
                    <div class="form-group">
                      <label for="exampleInputEmail1">Code specialize: </label>
                      <input type="text" class="form-control" id="exampleInputEmail1" name="speacialCode" value="<?php echo $specialCode; ?>" readonly>
                    </div>
                    <div class="form-group">
                      <label for="exampleInputEmail1">Name specialize: </label>
                      <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Import Name specialize" name="titleSpecial">
                    </div>
                    <div class="form-group">
                    ...
                    <?php 
                      if($_SESSION['level'] == 1)
                        echo "<button type='submit' class='btn btn-primary' name='save'><i class='fa fa-plus'></i> Add specialize</button>";
                    ?>
                  </div>
                  <!-- /.col -->
                </div>
          ...
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">List specialize</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <div class="table-responsive">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                    <th>STT</th>
                    <th>Code specialize</th>
                    <th>Name specialize</th>
                    <th>Description</th>
                    <th>Creator</th>
                    <th>Date created</th>
                    <th>Repairer</th>
