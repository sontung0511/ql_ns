...
if(isset($_SESSION['username']) && isset($_SESSION['level']))
{
  ...
  {
    $id = $_GET['id'];
    $showData = "SELECT id, ma_chuc_vu, ten_chuc_vu, ghi_chu, nguoi_tao, ngay_tao, nguoi_sua, ngay_sua FROM chuc_vu WHERE id = $id ORDER BY ngay_tao DESC";
...
success';
      echo '<script>setTimeout("window.location=\'sua-position.php?p=staff&a=position&id='.
      $id.'\'",1000);</script>';
    }
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Correction repair position</li>
      </ol>
    </section>
        ...
        <div class="col-xs-12">
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Correction repair position</h3>
...
Import Name position" value="<?php echo $row['ten_chuc_vu']; ?>" name="titlePosition">
                    </div>
