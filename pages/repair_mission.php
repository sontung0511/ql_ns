  ...
  if(isset($_POST['save']))
  {
    ...
    if(!$error)
    {
      ...
      if($result)
      {
        ...
        echo '<script>setTimeout("window.location=\'sua-mission.php?p=collaborate&a=add-collaborate&id='.$id.'\'",1000);</script>';
      }
    }
  }
                ...
                <div class="row">
                  <div class="col-md-12">
                    ...
                    <div class="form-group">
                      ...
                      <small style="color: red;"><?php if(isset($error['ngayKetThuc'])){ echo 'Please SelectEnd date';} ?></small>
                    </div>
                    <div class="form-group">
                      <label for="exampleInputEmail1">Mission location<span style="color: red;">*</span>: </label>
                      <input type="text" class="form-control" id="exampleInputEmail1" name="diaDiem" placeholder="Please enterlocation" value="<?php echo $rowAct['dia_diem']; ?>">
