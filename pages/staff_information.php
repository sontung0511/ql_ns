  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="employee_list.php?p=staff&a=list-staff">List of employee</a></li>
        ...
        <div class="col-xs-12">
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Code employee: <?php echo $row['ma_nv']; ?></h3>
            ...
            <div class="box-body">
              <div class="row">
                ...
                <div class="col-lg-5 col-sm-5 col-md-6 col-xs-12">
                  <p class="box-title">Name employee: <b><?php echo $row['ten_nv']; ?></b></p>
