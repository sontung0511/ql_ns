...
if(isset($_SESSION['username']) && isset($_SESSION['level']))
{
  ...
  {
    $id = $_POST['idRoom'];
    echo "<script>location.href='sua-position.php?p=staff&a=position&id=".$id."'</script>";
  }

  // show data
  $showData = "SELECT id, ma_chuc_vu, ten_chuc_vu, ghi_chu, nguoi_tao, ngay_tao, nguoi_sua, ngay_sua FROM chuc_vu ORDER BY ngay_tao DESC";
  ...
  if(isset($_POST['save']))
  {
    ...
    if(empty($titlePosition))
      $error['titlePosition'] = 'Please enter <b> Name position </b>';

    if(!$error)
    {
      $showMess = true;
      $insert = "INSERT INTO chuc_vu(ma_chuc_vu, ten_chuc_vu,  ghi_chu, nguoi_tao, ngay_tao, nguoi_sua, ngay_sua) VALUES('$positionCode','$titlePosition', '$salary', '$description', '$personCreate', '$dateCreate', '$personEdit', '$dateEdit')";
      mysqli_query($conn, $insert);
      $success['success'] = 'Add position success';
      echo '<script>setTimeout("window.location=\'position.php?p=staff&a=position\'",1000);</script>';
    }
        ...
        <form method="POST">
          ...
          <div class="modal-body">
            <input type="hidden" name="idPosition">
              do you really want Delete position here?
          </div>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="position.php?p=staff&a=position">position</a></li>
                ...
                <div class="row">
                  <div class="col-md-12">
                    <div class="form-group">
                      <label for="exampleInputEmail1">Code position: </label>
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Import Name position" name="titlePosition">
                    </div>
