  ...
  if(isset($_POST['save']))
  {
    ...
    if(!$error)
    {
      ...
      if($result)
      {
        ...
        echo '<script>setTimeout("window.location=\'sua-degree.php?p=staff&a=certificate&id='.$id.'\'",1000);</script>';
      }
    }
  }
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Correction repair qualifications</li>
      </ol>
    </section>
        ...
        <div class="col-xs-12">
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title"> repair qualifications</h3>
                ...
                <div class="row">
                  <div class="col-md-12">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Import Name qualifications" name="certificateName" value="<?php echo $row['ten_bang_cap']; ?>">
                    </div>
                    <div class="form-group">
