...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="index.php?p=index&a=statistic" class="logo">
      ...
      <span class="logo-lg"><b>PSI</b></span>
    </a>
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-header">
                ...
                <p>
                  ...
                  <small>
                    <?php 
                      echo "Lượt Access: " . $row_acc['truy_cap']; 
                    ?>
                  </small>
                </p>
              </li>
              ...
              <li class="user-footer">
                <div class="pull-left">
                  <a href="account_information.php?p=account&a=profile" class="btn btn-default btn-flat">Thông tin</a>
                </div>
